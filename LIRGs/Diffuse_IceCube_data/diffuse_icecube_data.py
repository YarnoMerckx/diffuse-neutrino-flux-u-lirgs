...
def read_out_diffuse_HESE_data(filename="Diffuse_IceCube_data/diffuse_HESE_7.5_year_differential.txt"):
    f = open(filename,"r")
    lines = f.readlines() 
...
flux,   flux_lower_err,   flux_upper_err = read_out_diffuse_HESE_data(filename="Diffuse_IceCube_data/diffuse_HESE_7.5_year_differential.txt")
...
energy_numu, flux_lower = read_out_diffuse_data("Diffuse_IceCube_data/diffuse_numu_9.5_year_lower_band.txt",
                                                 energy_range_numu.min(),
                                                 energy_range_numu.max(),
                                                 steps=1e3)

energy_numu, flux_upper = read_out_diffuse_data("Diffuse_IceCube_data/diffuse_numu_9.5_year_upper_band.txt",
                                                 energy_range_numu.min(),
                                                 energy_range_numu.max(),
                                                 steps=1e3)
